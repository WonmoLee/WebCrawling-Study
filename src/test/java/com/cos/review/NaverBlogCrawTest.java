...
public class NaverBlogCrawTest {
	...
	public void dayParse() {
		...
		String type2 = "1시간 전";
		String type3 = "3일 전";
		String type4 = "2020-08-10.";
		
		if(type1.contains("분 전") ||type1.contains("시간 전")) {
			type1 = LocalDate.now().toString();
		}
		
		System.out.println(type1);
		
		if(type3.contains("일 전")) {
			type3 = type3.replace("일 전", "");
			
			LocalDate today = LocalDate.now();
			
			type3 = today.minusDays(Integer.parseInt(type3)).toString();
		}
